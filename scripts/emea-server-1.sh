...
# copy consul config
cp -ap /vagrant/conf/emea-server-1-consul.hcl /etc/consul.d/
...
cp -ap /vagrant/conf/emea-server-1-nomad.hcl /etc/nomad.d/
...
cp -ap /vagrant/conf/emea-server-1-env.sh /etc/profile.d/
...
cp /vagrant/conf/code-server.service /etc/systemd/system/
cp -R /vagrant/conf/code-server /home/vagrant/
