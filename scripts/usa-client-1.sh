...
node_name = "usa-client-1"
data_dir = "/opt/consul/"
datacenter = "usa-dc1"
license_path = "/vagrant/lic/consul.hclic"
server = false
bind_addr = "192.168.56.84"
...
cp -ap /vagrant/conf/usa-client-1-nomad.hcl /etc/nomad.d/
...
cp -ap /vagrant/conf/usa-client-1-env.sh /etc/profile.d/
